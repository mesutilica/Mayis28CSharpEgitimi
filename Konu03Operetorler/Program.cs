namespace Konu03Operetorler
{
    internal class Program
    {
        static void Main(string[] args)
        {
            Console.WriteLine("Konu 03 Operetorler!");
            ...
            Console.WriteLine($"sayı 1({sayi1}) sayı 2({sayi2}) ye eşit mi? veya sayı 1({sayi1}) sayı 2({sayi2}) den küçük mü? " + ((sayi1 == sayi2) || (sayi1 < sayi2))); // şartlardan 1 tanesi true olması durumunda geri dönüş değeri true olur, tüm şartlar false ise false döner
            Console.WriteLine($"sayı 1({sayi1}) sayı 2({sayi2}) ye eşit mi? veya sayı 1({sayi1}) sayı 2({sayi2}) den büyük mü? " + ((sayi1 == sayi2) || (sayi1 > sayi2))); // şartlardan 1 tanesi true olması durumunda geri dönüş değeri true olur, tüm şartlar false ise false döner
        }
    }
}
